...
public class ProductServiceTest extends AbstractTest {
	...
	public void driverCreateProducts() {
		...
		Object testingData[][] = {
				 ...
				 * negative price
				 **/
				{ "salesMan1", "Name", "Description", typeProduct, -100, 10, true,
						ConstraintViolationException.class } };

		for (int i = 0; i < testingData.length; i++)
			this.createProductsTemplate((String) testingData[i][0], (String) testingData[i][1],
					(String) testingData[i][2], (TypeProduct) testingData[i][3], (Integer) testingData[i][4],
					(Integer) testingData[i][5], (Boolean) testingData[i][6], (Class<?>) testingData[i][7]);

	}

	private void createProductsTemplate(String salesMan, String name, String description, TypeProduct typeProduct,
			Integer price, Integer stock, Boolean isDraftMode, Class<?> expected) {
	...
	public void driverUpdateProducts() {
		...
		Object testingData[][] = {
				 ...
				 **/
				{ "socialWorker1", super.getEntityId("product2"), "Name", "Description", typeProduct, 5, 10, true,
						IllegalArgumentException.class },
				/**
				 * NEGATIVE TEST: SalesMan is trying to update a product that is
				 * in final mode
				 **/
				{ "salesMan1", super.getEntityId("product1"), "Name", "Description", typeProduct, 5, 10, true,
						IllegalArgumentException.class },
				/**
				 * NEGATIVE TEST: SalesMan is trying to update a product of
				 * another salesman
				 **/
				{ "salesMan1", super.getEntityId("product4"), "Name", "Description", typeProduct, 5, 10, true,
						IllegalArgumentException.class },
				/**
				 * NEGATIVE TEST: SalesMan is trying to update a product with
				 * the name in blank
				 **/
				{ "salesMan1", super.getEntityId("product2"), "", "Description", typeProduct, 5, 10, true,
						ConstraintViolationException.class },
				/**
				 * NEGATIVE TEST: SalesMan is trying to update a product with
				 * the type product as null
				 **/
				{ "salesMan1", super.getEntityId("product2"), "Name", "Description", null, 5, 10, true,
						IllegalArgumentException.class },
				/**
				 * NEGATIVE TEST: SalesMan is trying to update a product with
				 * negative price
				 **/
				{ "salesMan1", super.getEntityId("product2"), "Name", "Description", typeProduct, -100, 10, true,
						ConstraintViolationException.class } };

		for (int i = 0; i < testingData.length; i++)
			this.updateProductsTemplate((String) testingData[i][0], (Integer) testingData[i][1],
					(String) testingData[i][2], (String) testingData[i][3], (TypeProduct) testingData[i][4],
					(Integer) testingData[i][5], (Integer) testingData[i][6], (Boolean) testingData[i][7],
					(Class<?>) testingData[i][8]);

	}

	private void updateProductsTemplate(String salesMan, Integer productId, String name, String description,
			TypeProduct typeProduct, Integer price, Integer stock, Boolean isDraftMode, Class<?> expected) {
	...
	public void driverRestockProducts() {
		...
		for (int i = 0; i < testingData.length; i++)
			this.restockProductsTemplate((String) testingData[i][0], (Integer) testingData[i][1],
	...
	public void driverDeleteProducts() {
		...
		for (int i = 0; i < testingData.length; i++)
			this.deleteProductsTemplate((String) testingData[i][0], (Integer) testingData[i][1],
