...
public class CurriculumAndRecordsServicesTest extends AbstractTest {
	...
	public void driverDeleteEducationRecord() {
		...
		for (int i = 0; i < testingData.length; i++)
			this.deleteEducationRecordTemplate((String) testingData[i][0], (Integer) testingData[i][1],
	...
	public void driverCreateProfessionalRecord() {
		...
		Object testingData[][] = {
				 ...
				 * but he or she has not a curriculum
				 **/
				{ "socialWorker3", "Name", "Role", "http://www.attachment.com", date1, date2,
						IllegalArgumentException.class },
				/**
				 * NEGATIVE TEST: Another user is trying to create a
				 * professional record
				 **/
				{ "salesMan1", "Name", "Role", "http://www.attachment.com", date1, date2,
						IllegalArgumentException.class },
				/**
				 * NEGATIVE TEST: SocialWorker is trying to create a
				 * professional record with incorrect dates
				 **/
				{ "socialWorker1", "Name", "Role", "http://www.attachment.com", date3, date2,
						ConstraintViolationException.class },
				/**
				 * NEGATIVE TEST: SocialWorker is trying to create a
				 * professional record with a blank name
				 **/
				{ "socialWorker1", "", "Role", "http://www.attachment.com", date1, date2,
						ConstraintViolationException.class } };

		for (int i = 0; i < testingData.length; i++)
			this.createProfessionalRecordTemplate((String) testingData[i][0], (String) testingData[i][1],
					(String) testingData[i][2], (String) testingData[i][3], (Date) testingData[i][4],
					(Date) testingData[i][5], (Class<?>) testingData[i][6]);

	}

	private void createProfessionalRecordTemplate(String socialWorker, String name, String role, String attachment,
			Date startDate, Date endDate, Class<?> expected) {
	...
	public void driverUpdateProfessionalRecord() {
		...
		Object testingData[][] = {
				 ...
				 * with correct information
				 **/
				{ "socialWorker1", super.getEntityId("professionalRecord1"), "Name", "Role",
						"http://www.attachment.com", date1, date2, null },
				/**
				 * NEGATIVE TEST: SocialWorker is trying to update a
				 * professional record but he or she has not a curriculum
				 **/
				{ "socialWorker3", super.getEntityId("professionalRecord1"), "Name", "Role",
						"http://www.attachment.com", date1, date2, IllegalArgumentException.class },
				/**
				 * NEGATIVE TEST: SocialWorker is trying to update a
				 * professional record that does not belong to him or her
				 **/
				{ "socialWorker2", super.getEntityId("professionalRecord1"), "Name", "Role",
						"http://www.attachment.com", date1, date2, IllegalArgumentException.class },
				/**
				 * NEGATIVE TEST: Another user is trying to update a
				 * professional record
				 **/
				{ "salesMan1", super.getEntityId("professionalRecord1"), "Name", "Role", "http://www.attachment.com",
						date1, date2, IllegalArgumentException.class },
				/**
				 * NEGATIVE TEST: SocialWorker is trying to update a
				 * professional record with incorrect dates
				 **/
				 ...
				 **/
				{ "socialWorker1", super.getEntityId("professionalRecord1"), "", "Role", "http://www.attachment.com",
						date1, date2, ConstraintViolationException.class } };
	...
	private void updateProfessionalRecordTemplate(String socialWorker, Integer professionalRecordId, String name,
			String role, String attachment, Date startDate, Date endDate, Class<?> expected) {
		...
		try {
			...
			this.professionalRecordService.getProfessionalRecordOfLoggedSocialWorker(professionalRecordId);
	...
	public void driverDeleteProfessionalRecord() {
		...
		for (int i = 0; i < testingData.length; i++)
			this.deleteProfessionalRecordTemplate((String) testingData[i][0], (Integer) testingData[i][1],
					(Class<?>) testingData[i][2]);

	}

	private void deleteProfessionalRecordTemplate(String socialWorker, Integer professionalRecordId,
			Class<?> expected) {
