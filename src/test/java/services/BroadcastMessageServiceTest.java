		...
		Object testingData[][] = {
			{
				...
				//Negative test, a prisoner broadcast a message
				"prisoner1", "prisoner1", "subject", "body", "tags", "warden2", IllegalArgumentException.class
			}
		};

		for (int i = 0; i < testingData.length; i++)
			this.templateBroadcastMessage((String) testingData[i][0], (String) testingData[i][1], (String) testingData[i][2], (String) testingData[i][3], (String) testingData[i][4], (String) testingData[i][5], (Class<?>) testingData[i][6]);
	}

	protected void templateBroadcastMessage(String username, String usernameVerification, String subject, String body, String tags, String receiver, Class<?> expected) {
