		...
		Object testingData[][] = {
			{
				...
				"warden1", "message1", "inBoxWarden1", null
			}, {
				//Negative test, move message to a box is not yours
				"warden1", "message1", "inBoxwarden2", IllegalArgumentException.class
			}, {
				//Negative test, move message is not yours to your box
				"warden1", "message3", "inBoxwarden1", IllegalArgumentException.class
			}
		};
